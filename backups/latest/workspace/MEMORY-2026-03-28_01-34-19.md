...
- Google account split: `jrybchin@gmail.com` is the personal/general account and should be preferred for GitHub, Hugging Face, GPT Premium, and general non-student workflows; `jrybchin@terpmail.umd.edu` is the school/student-benefit account and should be preferred for UMD, student discounts, and school-oriented Docs/Drive/Calendar workflows unless the user says otherwise.
- When Google-account choice is task-dependent, prefer Terpmail for school/UMD/student-benefit contexts and Gmail for personal/general contexts.
