...
- LIVE-STATE.md
- RECOVERY-BRIEF.md when an active incident or recovery handoff exists

### Reference layer
Use Reference docs for repair history, durable historical lessons, and supporting continuity.

### Mirror layer
Use mirror docs when the goal is faster reconstruction with less noise than the full memory/history stack.
