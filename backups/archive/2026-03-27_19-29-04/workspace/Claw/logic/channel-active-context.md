...
- Mission Control now exists as a local Next.js control surface and also has a native route/page inside the OpenClaw Control UI.
...
## Current Priority
- Finish the backend unobtrusive local-to-Drive sync layer for live/current docs.
